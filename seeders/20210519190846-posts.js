...
const postData = [
 ...
 {
   title: `'Dark Witch': Paranormal, yes. Romance, not even a little`,author: `Annie`,
   content: `Sure, there IS a romance in this novel. Iona and Boyle meet, chat, wink at each, flirt some, sleep together...big deal. But if you enjoy a solid background story with some dark magic and prophecies, read this and we can talk.`,
   userId: 2,
   createdAt: new Date(),
   updatedAt: new Date()
 },
 {
   title: `Can ANYONE explain to me the point of 'The Left Hand of God'`,author: `Billy`,
